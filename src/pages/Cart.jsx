                    ...
                    <div key={itemKey} className="r2c-cart__item">
                      ...
                      <div className="r2c-cart__item-info">
                        ...
                        <div className="r2c-cart__item-qty">
                          ...
                          <button className="r2c-cart__qty-btn" onClick={() => updateQty(item.id, item.size, item.qty + 1)} disabled={item.stock > 0 && item.qty >= item.stock} style={item.stock > 0 && item.qty >= item.stock ? {opacity: .3, cursor: 'not-allowed'} : {}}>+</button>
                          {item.stock > 0 && <span className="r2c-cart__stock-info">{item.stock} dispo</span>}
